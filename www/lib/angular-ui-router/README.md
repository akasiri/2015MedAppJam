...
<head>
    ...
    <script>
        ...
        // var SocialSolari = angular.module('SocialSolari', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
SocialSolari.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
SocialSolari.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
